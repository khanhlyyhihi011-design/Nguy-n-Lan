...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Lan - Trường Tiểu học Vĩnh Hảo - ĐT: 0915891238</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Lan - Trường Tiểu học Vĩnh Hảo - ĐT: 0915891238</div>", unsafe_allow_html=True)
